...
--AGGREGATE FUNCTION WITH HAVING AND WHERE CLAUSE--
SELECT Customer.CustomerID, Customer.LastName, Customer.FirstName,CustomerOrder.OrderDate,
SUM(CustomerOrder.Bill) as 'Total Bill'
FROM Customer INNER JOIN CustomerOrder
ON Customer.CustomerID=CustomerOrder.CustomerID
...
SELECT CustomerOrder.CustomerID, Customer.LastName, Customer.FirstName,CustomerOrder.OrderDate,CustomerOrder.Bill
FROM CustomerOrder
LEFT JOIN Customer
ON Customer.CustomerID=CustomerOrder.CustomerID
...
--RIGHT JOIN--
SELECT Customer.CustomerID, Customer.LastName, Customer.FirstName,
SUM(CustomerOrder.Bill) as 'Total Bill',CustomerOrder.OrderID
